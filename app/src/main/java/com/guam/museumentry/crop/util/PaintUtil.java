...
package com.guam.museumentry.crop.util;
...
public class PaintUtil {
    ...
    private static final int DEFAULT_CORNER_COLOR = Color.MAGENTA;
    private static final String SEMI_TRANSPARENT = "#AAFF0000";
    private static final String DEFAULT_BACKGROUND_COLOR_ID = "#B0000000";
    private static final float DEFAULT_LINE_THICKNESS_DP = 3;
    private static final float DEFAULT_CORNER_THICKNESS_DP = AndroidUtilities.dp(1);
