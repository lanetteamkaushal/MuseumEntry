...
import com.guam.museumentry.crop.cropwindow.handle.Handle;
import com.guam.museumentry.crop.util.HandleUtil;
import com.guam.museumentry.crop.util.PaintUtil;
...
//        drawBackground(canvas, mBitmapRect);
     ...
     */
    public void setBitmapRect(Rect bitmapRect, Boolean isSquare) {
...
//
//            Edge.LEFT.setCoordinate(bitmapRect.left/2 + horizontalPadding);
//            Edge.TOP.setCoordinate(bitmapRect.top/2 + verticalPadding);
//            Edge.RIGHT.setCoordinate(bitmapRect.right/2 - horizontalPadding);
//            Edge.BOTTOM.setCoordinate(bitmapRect.bottom/2 - verticalPadding);
//        }
//        else
//        {
        // Initialize crop window to have 10% padding w/ respect to image.
...
//        Edge.BOTTOM.setCoordinate(bitmapRect.bottom - verticalPadding);
        Rect rect = new Rect();
        rect.left = bitmapRect.left + AndroidUtilities.dp(8);
        rect.top = bitmapRect.top + AndroidUtilities.dp(8);
