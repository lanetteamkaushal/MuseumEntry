...
public abstract class StickerView extends FrameLayout {
    ...
    private final static int BUTTON_SIZE_DP = 24;
    private final static int SELF_SIZE_DP = 48;
    RectF rectCurrent = new RectF();
    ...
    private void printRect() {
        rectCurrent.set(xPos, yPos, xPos + SELF_SIZE_DP, yPos + SELF_SIZE_DP);
        Log.d(TAG, "printRect: " + rectCurrent.toString());
    }
