...
public class NotificationCenter {
    ...
    public static final int imageUploadStarted = totalEvents++;
    public static final int imageUploadFinished = totalEvents++;
    public static final int imageUploadFailed = totalEvents++;
    public static final int imageUploadUpdated = totalEvents++;

    public static final int messageIdUpdated = totalEvents++;
    public static final int messageStatusChanged = totalEvents++;

    public static final int messageDeleted = totalEvents++;
    public static final int messageRecalled = totalEvents++;

    public static final int messageReadyToSend = totalEvents++;

    public static final int userColorRequested = totalEvents++;
    public static final int userColorChanged = totalEvents++;

    public static final int albumsDidLoaded = totalEvents++;
    public static final int recentImagesDidLoaded = totalEvents++;

    public static final int messageReplaced = totalEvents++;
    public static final int mergePositionReceiver = totalEvents++;

    public static final int mergePositionChanged = totalEvents++;
    public static final int diReceiveSocketMessage = totalEvents++;
    public static final int didReceivedNewMessages = totalEvents++;
    public static final int mergePositionChangedByResp = totalEvents++;
...
//    public static final int audioRouteChanged = totalEvents++;
    public static final int videoThumbGenerated = totalEvents++;
    public static final int addClickedInBusinessCard = totalEvents++;
    ...
    public void postNotificationNameInternal(int id, boolean allowDuringAnimation, Object... args) {
        if (true) {
            if (Thread.currentThread() != GlobalApplication.applicationHandler.getLooper().getThread()) {
