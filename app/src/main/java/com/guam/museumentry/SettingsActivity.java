...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                boolean isDataEntry = (boolean) value;
                preference.setSummary(String.valueOf(isDataEntry));
                Log.d(TAG, "onPreferenceChange() called with: preference = [" + preference.getKey() + "], value = [" + isDataEntry + "]");
            } else {
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("power_preference"));
            bindPreferenceSummaryToValue(findPreference("entry_for"));
        }
